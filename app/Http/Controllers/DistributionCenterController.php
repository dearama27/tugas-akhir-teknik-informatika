...
class DistributionCenterController extends Controller
{
    ...
    protected $view  = 'distribution_center';
    ...
    public function index(DistributionCenter $model, Request $req) {
    ...
    public function edit(DistributionCenter $model, $id) {
    ...
    public function store(DistributionCenter $model, Request $req) {

        try {   
            DB::beginTransaction();
            if(isset($req->id)) {
                $model = DistributionCenter::find($req->id);
            }

			$model->name      = $req->name;
			$model->dc_code      = $req->dc_code;
    ...
    public function destroy(DistributionCenter $model, $id) {
